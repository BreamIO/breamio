...
//It will not care for anything you tell it
...
type MockCoordHandler struct {
	desiredFreq int
	scaling float64
}

func NewMockCoordHandler(coordSource chan Coordinate, interval time.Duration, desiredFreq int) *MockCoordHandler {
	return &MockCoordHandler{
...
func (m MockCoordHandler) GetCoords() (coords chan *Coordinate) {
